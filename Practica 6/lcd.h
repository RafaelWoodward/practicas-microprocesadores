...
// Crea un caracter personalizado en la CGRAM del LCD
// pos: posicion 0-7 donde se guarda el caracter
// patron_char: arreglo de 8 bytes que define los pixeles del caracter
